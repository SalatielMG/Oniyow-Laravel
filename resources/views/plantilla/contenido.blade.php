...
<div class="home">
    <div class="home_background_container prlx_parent">
        <div class="home_background prlx" style="background-image:url({{ asset('images/slider_background.jpg)') }}"></div>
    </div>
...
<div class="cta">
    <div class="cta_background" style="background-image:url({{ asset('images/cta_background.jpg)') }}"></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 offset-lg-1 order-lg-2 order-1">
                <div class="cta_image d-flex flex-column justify-content-end">
                    <img src="{{ asset('images/cta.png') }}" alt="image by https://unsplash.com/@heysupersimi">
                </div>
            </div>
        </div>
    </div>
